...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sendMail = sendMail($email, 'Kích hoạt tài khoản', 'Vui lòng click vào link sau để kích hoạt tài khoản: <a href="'.BASE_URL.'?module=auth&action=active&token=' . $activeToken . '">Kích hoạt</a>');
